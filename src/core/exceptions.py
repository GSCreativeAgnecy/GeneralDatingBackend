...
class StripeIntegrationError(AppException):
    def __init__(self, detail: str = "Payment provider is not configured"):
        super().__init__(503, detail, "stripe_integration_error")
